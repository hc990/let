...
decoding_table = (
    ...
    u'\u0105'   #  0x86 -> LATIN SMALL LETTER A WITH OGONEK
    ...
    u'\u0104'   #  0x8F -> LATIN CAPITAL LETTER A WITH OGONEK
    u'\u0118'   #  0x90 -> LATIN CAPITAL LETTER E WITH OGONEK
    u'\u0119'   #  0x91 -> LATIN SMALL LETTER E WITH OGONEK
    u'\u0142'   #  0x92 -> LATIN SMALL LETTER L WITH STROKE
    u'\u201c'   #  0x93 -> LEFT DOUBLE QUOTATION MARK
    u'\u201d'   #  0x94 -> RIGHT DOUBLE QUOTATION MARK
    u'\u0106'   #  0x95 -> LATIN CAPITAL LETTER C WITH ACUTE
    u'\u2013'   #  0x96 -> EN DASH
    u'\u2014'   #  0x97 -> EM DASH
    u'\u015a'   #  0x98 -> LATIN CAPITAL LETTER S WITH ACUTE
    u'\u2122'   #  0x99 -> TRADE MARK SIGN
    u'\u0161'   #  0x9A -> LATIN SMALL LETTER S WITH CARON
    u'\u203a'   #  0x9B -> SINGLE RIGHT-POINTING ANGLE QUOTATION MARK
    u'\u0141'   #  0x9C -> LATIN CAPITAL LETTER L WITH STROKE
    u'\u0165'   #  0x9D -> LATIN SMALL LETTER T WITH CARON
    u'\u015b'   #  0x9E -> LATIN SMALL LETTER S WITH ACUTE
    u'\ufffe'
    u'\u0179'   #  0xA0 -> LATIN CAPITAL LETTER Z WITH ACUTE
    u'\u017b'   #  0xA1 -> LATIN CAPITAL LETTER Z WITH DOT ABOVE
    u'\xf3'     #  0xA2 -> LATIN SMALL LETTER O WITH ACUTE
    u'\xd3'     #  0xA3 -> LATIN CAPITAL LETTER O WITH ACUTE
    u'\u0144'   #  0xA4 -> LATIN SMALL LETTER N WITH ACUTE
    u'\u0143'   #  0xA5 -> LATIN CAPITAL LETTER N WITH ACUTE
    u'\u017a'   #  0xA6 -> LATIN SMALL LETTER Z WITH ACUTE
    u'\u017c'   #  0xA7 -> LATIN SMALL LETTER Z WITH DOT ABOVE
...
print Codec().decode("fdsfsd")
print Codec().encode("fdsfsd")
print Codec().decode(Codec().encode("dfsdfsd"))
